...
% topoplotIndie - create an EEG topographical map
% 
%  INPUTS
%       Values: a vector (chan X 1) of values to visualize
%     chanlocs: an eeglab structure of channel locations
% 
% 
% Note: This is a hacked version of eeglab's topoplot() function.
%       This version does not require the toolbox.
